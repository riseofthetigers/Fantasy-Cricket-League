...
<html class="ie ie7" lang="en-US">
 ...
 <div id="main">
                                    ...
                                    <div class="wpb_wrapper">
                                       <div class="vc_latest_result">
                                          <div class="fixture_detail clearfix">
                                             <?php if(!isset($_GET["fixture"])) echo '<h2 style="color:white;">Latest Results</h2>'; ?>
                                             <h3>VESIT CRICKET LEAGUE</h3>
                                             <?php
                     if(isset($_GET["fixture"]))
                     {
                        $match_id=$_GET["fixture"];
                        settype($match_id, "integer");
                        $query=mysqli_query($con,"SELECT * from fixtures where fixture_id='".$match_id."'") OR die(mysqli_error($con));
                     }
                     else
                     ...
                     if(mysqli_num_rows($query)>0)
                     {
                        ...
                        elseif($temp1[0]==$temp2[0] && $temp1[0]!=NULL && $temp2[0]!=NULL)
                        {
                           $team2res="tie";
                           $team1res="tie";
                        }
                              ...
                              <div class="vc_col-sm-12 wpb_column vc_column_container">
                                 <div class="wpb_wrapper">
                                    <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                       <h4 style="color: #fff;margin: 0;text-transform: uppercase;">Scorecard</h4>
                                    </div>
                                    <div class="vc_col-sm-6 wpb_column vc_column_container">
                                       <div class="wpb_wrapper">
                                          <div class="goals">
                                             <h2><a href="javascript:void(0)" style="color:dimgray;"><?php echo team($row["team1"]) ?> Innings</a></h2>
                                             <h4 style="text-transform:uppercase;"><?php echo $team1res; ?></h4>
                                             <h3><?php echo $row["team1score"].' in '.$row["team1over"].' Ovrs'; ?></h3>
                                             <br/>
                                          </div>
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;"><?php echo team($row["team1"]) ?> Batting</h4>
                                             </div>
                                                   ...
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="11">
                                                      <thead>
                                                         <tr>
                                                            ...
                                                            <th class="data-w">R</th>
                                                            <th class="data-w">B</th>
                                                            <th class="data-l">4s</th>
                                                            <th class="data-l">6s</th>
                                                            <th class="data-pts">S/R</th>
                                                            <th class="data-pts">Pts</th>
                                                         </tr>
                                                      </thead>
                                                      <tbody>
                                                      <?php
                                                         $result2=mysqli_query($con,"SELECT * FROM players INNER  JOIN scorecard ON players.`player_id`=scorecard.`player_id`where fixture_id='".$row["fixture_id"]."' AND team='".$row["team1"]."' AND matchplayed<>false AND batted<>false Order by runscore desc");
                                                         while($row2=mysqli_fetch_array($result2))
                                                         {
                                                            $no = NULL;
                                                            if($row2["notout"])
                                                               $no="*";
                                                            echo '<tr class="odd"><td class="data-name">'.$row2["name"].'</td>
                                                            <td class="data-w">'.$row2["runscore"].' '.$no.'</td>
                                                            <td class="data-w">'.$row2["ballfaced"].'</td>
                                                            <td class="data-l">'.$row2["four"].'</td>
                                                            <td class="data-l">'.$row2["six"].'</td>
                                                            <td class="data-pts">'.$row2["strrate"].'</td>
                                                            <td class="data-pts">'.$row2["point"].'</td></tr>';
                                                         }
                                                      ?>
                                                      </tbody>
                                                   </table>
                                             ...
                                             <br/>
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;"><?php echo team($row["team2"]) ?> Bowling</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="11">
                                                      ...
                                                      <tbody>
                                                      <?php
                                                         $result3=mysqli_query($con,"SELECT * FROM players INNER JOIN scorecard ON players.`player_id`=scorecard.`player_id`where fixture_id='".$row["fixture_id"]."' AND team='".$row["team2"]."' AND matchplayed<>false AND bowled<>false Order by wicket desc,runconceded asc");
                                                         while($row3=mysqli_fetch_array($result3))
                                                         {
                                                            $over=(int)($row3["ballbowled"]/6);
                                                            $overs=$over.".".($row3["ballbowled"]-($over*6));
                                                            echo '<tr class="odd"><td class="data-name">'.$row3["name"].'</td>
                                                            <td class="data-w">'.$overs.'</td>
                                                            <td class="data-w">'.$row3["maidenbowled"].'</td>
                                                            <td class="data-l">'.$row3["runconceded"].'</td>
                                                            <td class="data-l">'.$row3["wicket"].'</td>
                                                            <td class="data-pts">'.$row3["economy"].'</td>
                                                            <td class="data-pts">'.$row3["point"].'</td></tr>';
                                                         }
                                                      ?>
                                                      </tbody>
                                                   </table>
                                       ...
                                       <div class="vc_col-sm-6 wpb_column vc_column_container">
                                          <div class="wpb_wrapper">
                                             <div class="goals">
                                                <h2><a href="javascript:void(0)" style="color:dimgray;"><?php echo team($row["team2"]) ?> Innings</a></h2>
                                                <h4 style="text-transform:uppercase;"><?php echo $team2res; ?></h4>
                                                <h3><?php echo $row["team2score"].' in '.$row["team2over"].' Ovrs'; ?></h3>
                                                <br/>
                                             </div>
                                                <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;"><?php echo team($row["team2"]) ?> Batting</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="11">
                                                      ...
                                                      <tbody>
                                                      <?php
                                                         $result4=mysqli_query($con,"SELECT * FROM players INNER JOIN scorecard ON players.`player_id`=scorecard.`player_id`where fixture_id='".$row["fixture_id"]."' AND team='".$row["team2"]."' AND matchplayed<>false AND batted<>false Order by runscore desc");
                                                         while($row4=mysqli_fetch_array($result4))
                                                         {
                                                            $no = NULL;
                                                            if($row4["notout"])
                                                               $no="*";
                                                            echo '<tr class="odd"><td class="data-name">'.$row4["name"].'</td>
                                             ...
                                             <br/>
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;"><?php echo team($row["team1"]) ?> Bowling</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="11">
                                                      ...
                                                      <tbody>
                                                      <?php
                                                         $result3=mysqli_query($con,"SELECT * FROM players INNER JOIN scorecard ON players.`player_id`=scorecard.`player_id`where fixture_id='".$row["fixture_id"]."' AND team='".$row["team1"]."' AND matchplayed<>false AND bowled<>false Order by wicket desc,runconceded asc");
                                                         while($row5=mysqli_fetch_array($result3))
                                                         {
                                                            $over=(int)($row5["ballbowled"]/6);
                                                            $overs=$over.".".($row5["ballbowled"]-($over*6));
                                                            echo '<tr class="odd"><td class="data-name">'.$row5["name"].'</td>
                                                            <td class="data-w">'.$overs.'</td>
                                                            <td class="data-w">'.$row5["maidenbowled"].'</td>
                                                            <td class="data-l">'.$row5["runconceded"].'</td>
                                                            <td class="data-l">'.$row5["wicket"].'</td>
                                                            <td class="data-pts">'.$row5["economy"].'</td>
                                                            <td class="data-pts">'.$row5["point"].'</td></tr>';
                                                         }
                                                      ?>
                                                      </tbody>
                                                   </table>
