                       ...
                       <div class="col-sm-10">
                        <article id="post-2342" class="post-2342 sp_table type-sp_table status-publish hentry">
                           ...
                           <div class="entry-content">
                              ...
                              <div  class="vc_clearfix">
                                 <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                    <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="7">
                                       <thead>
                                          <tr>
                                             <th style="width:25%;" class="data-rank">WicketKeeper</th>
                                             <th style="width:25%;" class="data-rank">Batsmen</th>
                                             <th style="width:25%;" class="data-l">All Rounder</th>
                                             <th style="width:25%;" class="data-l">Bowler</th>
                                          </tr>
                                       </thead>
                                       <tbody>
                                          <tr class="odd">
                                             <td style="width:25%;" class="data-rank">1</td>
                                             <td style="width:25%;" class="data-rank">5</td>
                                             <td style="width:25%;" class="data-l">2</td>
                                             <td style="width:25%;" class="data-l">3</td>
                                          </tr>
                                          <tr class="even">
                                             <td style="width:25%;" class="data-rank">1</td>
                                             <td style="width:25%;" class="data-rank">5</td>
                                             <td style="width:25%;" class="data-l">1</td>
                                             <td style="width:25%;" class="data-l">4</td>
                                          </tr>
                                          <tr class="odd">
                                             <td style="width:25%;" class="data-rank">1</td>
                                             <td style="width:25%;" class="data-rank">4</td>
                                             <td style="width:25%;" class="data-l">1</td>
                                             <td style="width:25%;" class="data-l">5</td>
                                          </tr>
                                          <tr class="even">
                                             <td style="width:25%;" class="data-rank">1</td>
                                             <td style="width:25%;" class="data-rank">4</td>
                                          ...
                                          <tr class="even">
                                             <td style="width:25%;" class="data-rank">1</td>
                                             <td style="width:25%;" class="data-rank">3</td>
                                             <td style="width:25%;" class="data-l">2</td>
                                             <td style="width:25%;" class="data-l">5</td>
                                          </tr>
                                          <tr class="odd">
                              ...
                              <p><span style="font-size: 16px; color: #252c33;">1.Click on play butoon on the navigation bar</span></p><br/>
