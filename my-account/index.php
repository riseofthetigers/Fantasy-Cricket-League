...
<!-- Mirrored from champion.stylemix.net/my-account/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Dec 2014 18:03:48 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>VCL FANTASY</title>
...
<link rel="alternate" type="application/rss+xml" title="FC Champion &raquo; My Account Comments Feed" href="feed/index.html" />
...
<link rel='stylesheet' id='woocommerce_chosen_styles-css'  href='../wp-content/plugins/woocommerce/assets/css/chosenf39e.css?ver=4.0.1' type='text/css' media='all' />
...
<link rel='stylesheet' id='theme-style-css'  href='../wp-content/themes/champion/assets/css/style298b.css?ver=1418925178' type='text/css' media='all' />
<link rel='stylesheet' id='theme-mobile-style-css'  href='../wp-content/themes/champion/assets/css/mobile298b.css?ver=1418925178' type='text/css' media='all' />
...
<script type='text/javascript' src='../wp-content/themes/champion/assets/js/fix-ie-css-limit-standalone298b.js?ver=1418925178'></script>
...
<link rel='shortlink' href='../indexdccb.html?p=1863' />
		<script type="text/javascript">
...
<link rel="alternate" hreflang="fr-FR" href="../fr/my-account/index.html" />
<link rel="alternate" hreflang="de-DE" href="../de/my-account/index.html" />
...
<body class="page page-id-1863 page-template-default mmm mega_main_menu-2-0-2 ivan-vc-enabled woocommerce-account woocommerce-page  nav_bar_static wpb-js-composer js-comp-ver-4.3.4 vc_responsive">
   <div id="wrapper">
                     ...
                     <div class="col2-set" id="customer_login">
                        <div class="col-1">
                           ...
                           <form method="post" class="login">
                              <p class="form-row form-row-wide">
                                 <input type="text" placeholder="E-mail address *" class="input-text" name="username" id="email" value="" />
                              </p>
                              <p class="form-row form-row-wide">
                                 <input class="input-text" placeholder="Password *" type="password" name="password" id="passwd" />
                              </p>
                              <div class="form-row" style="margin: 0;">
								 <div style="color:white;" id="login_status"></div>
                                 <input type="button" onclick="vpb_users_login();" class="btn btn-danger" name="login" value="Login" />
                        ...
                        <div class="col-2">
                           ...
                           <form method="post" class="register">
							  <p class="form-row form-row-wide">
                              <input placeholder="Enter your full name" type="text" id="uname" class="input-text" />
							  </p>
							  <p class="form-row form-row-wide">
							  <input placeholder="Enter your Contact" type="text" id="contact" class="input-text" />
							  </p>
							  <p class="form-row form-row-wide">
							  <input placeholder="Enter your Class" type="text" id="class" class="input-text" />
							  </p>
							  <p class="form-row form-row-wide">
							  <input placeholder="Enter your Team Name" type="text" id="userid" class="input-text" />
							  </p>
							  <p class="form-row form-row-wide">
                              <input placeholder="Enter your email" type="text" id="remail" class="input-text" />
							  </p>
							  <p class="form-row form-row-wide">
                              <input placeholder="Enter password" type="password" id="rpasswd" class="input-text" />
							  </p>
                              <p class="form-row" style="margin: 0;">
								 <div style="color:white;" id="signup_status"></div>
                                 <input type="button" onclick="vpb_users_registration();" class="btn btn-info white" name="register" value="Register" />
                              </p>
                           </form>
                        </div>
                     </div>
   ...
   <script type='text/javascript' src='../wp-content/plugins/sportspress/assets/js/sportspress298b.js?ver=1418925178'></script>
   ...
   <script type='text/javascript' src='../wp-content/plugins/woocommerce/assets/js/frontend/chosen-frontend.min7888.js?ver=2.2.8'></script>
   ...
   <script type='text/javascript' src='../wp-content/themes/champion/assets/js/bootstrap.min298b.js?ver=1418925178'></script>
   <script type='text/javascript' src='../wp-content/themes/champion/assets/js/select2.min298b.js?ver=1418925178'></script>
   <script type='text/javascript' src='../wp-content/themes/champion/assets/js/jquery.fancybox.pack298b.js?ver=1418925178'></script>
   <script type='text/javascript' src='../wp-content/themes/champion/assets/js/jquery.nicescroll.min298b.js?ver=1418925178'></script>
   <script type='text/javascript' src='../wp-content/themes/champion/assets/js/custom298b.js?ver=1418925178'></script>
   <script type='text/javascript' src='../wp-content/themes/champion/assets/js/owl.carousel.min298b.js?ver=1418925178'></script>
