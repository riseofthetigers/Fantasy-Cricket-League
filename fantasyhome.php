                 ...
                 <?php include "headerfantasy.php"; ?>
                  ...
                  <div id="main">
                     ...
                     echo '<div class="command_left">
                                 ...
                                 <div class="vc_col-sm-12 wpb_column vc_column_container">
                                    <div class="wpb_wrapper">
                                       ...
                                       <div class="vc_col-sm-6 wpb_column vc_column_container">
                                          <div class="wpb_wrapper">
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;">Top Scoring Users</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="7">
                                                      <thead>
                                                         <tr>
                                                            <th class="data-rank">Pos</th>
                                                      ...
                                                      <tbody>
                                                         <?php
                                                            $query8=mysqli_query($con,"SELECT * from users Order by points desc") OR die(mysqli_error());
                                                            $i=1;
                                                            while($row=mysqli_fetch_array($query8))
                                                            {
                                                            	echo '<tr class="odd"><td class="data-rank">'.$i.'</td><td class="data-name">'.$row['user_id'].'</td><td class="data-pts">'.$row['points'].'</td></tr>';
                                                            	$i++;
                                                            }
                                                            ?>
                                                      </tbody>
							  ...
							  $sumUsers=mysqli_num_rows($result);
							  $result1=mysqli_query($con,"select * from players order by captained desc LIMIT 5");
							  $result2=mysqli_query($con,"select * from players order by vcaptained desc LIMIT 5");
							  $result3=mysqli_query($con,"select * from players order by selected desc LIMIT 5");
							  ?>
                                       <div class="vc_col-sm-6 wpb_column vc_column_container">
                                          <div class="wpb_wrapper">
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;">Top Selected Players</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="5">
                                                      <thead>
                                                         <tr>
                                                            <th class="data-rank">POS</th>
                                                            <th class="data-rank">Name</th>
															<th class="data-rank">Team</th>
                                                            <th>% Selected</th>
                                                         </tr>
                                                      </thead>
                                                      <tbody>
															<?php $i=1; while($row=mysqli_fetch_array($result3)) { ?>
															<tr>
															<td class="data-rank"><?php echo $i; ?></td>
															<td class="data-rank"><?php echo $row['name']; ?></td>
															<td class="data-rank"><?php echo $row['team']; ?></td>
															<td><?php echo number_format((float)($row['selected']/$sumUsers)*100, 2, '.', ''); ?>%</td>
															</tr>
															<?php $i++; } ?>
                                                      </tbody>
                                                   </table>
                                 ...
                                 <div class="vc_col-sm-12 wpb_column vc_column_container">
                                    <div class="wpb_wrapper">
                                       ...
                                       <div class="vc_col-sm-6 wpb_column vc_column_container">
                                          <div class="wpb_wrapper">
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;">Top Captained Players</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="5">
                                                      ...
                                                      <tbody>
															...
															<td class="data-rank"><?php echo $row['name']; ?></td>
															<td class="data-rank"><?php echo $row['team']; ?></td>
															<td><?php echo number_format((float)($row['captained']/$sumUsers)*100, 2, '.', ''); ?>%</td>
                                       ...
                                       <div class="vc_col-sm-6 wpb_column vc_column_container">
                                          <div class="wpb_wrapper">
                                             <div class="title" style="padding: 17px 10px;background: #b81e1f;text-align: center;margin: 0 0 10px;">
                                                <h4 style="color: #fff;margin: 0;text-transform: uppercase;">Top Vice-Captained Players</h4>
                                             </div>
                                             <div  class="vc_clearfix">
                                                <div class="vc_league_table sp-table-wrapper sp-scrollable-table-wrapper">
                                                   <table class="sp-league-table sp-data-table sp-responsive-table sp-sortable-table sp-paginated-table" data-sp-rows="5">
                                                      ...
                                                      <tbody>
															<?php $i=1; while($row=mysqli_fetch_array($result2)) { ?>
															<tr>
															<td class="data-rank"><?php echo $i; ?></td>
															<td class="data-rank"><?php echo $row['name']; ?></td>
															<td class="data-rank"><?php echo $row['team']; ?></td>
															<td><?php echo number_format((float)($row['vcaptained']/$sumUsers)*100, 2, '.', ''); ?>%</td>
